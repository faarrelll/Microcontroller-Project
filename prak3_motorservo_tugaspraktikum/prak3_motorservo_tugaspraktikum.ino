...
void loop(){ 
 for(pos = 45; pos < 136; pos += 1)  //fungsi perulangan yang akan dijadikan PWM dengan kenaikan 1
 {
 ...
 for(pos = 135; pos>=45; pos-=1)  //fungsi perulangan perubahan PWM dg penurunan 1
 {                              
  tunda=(int)analogRead(A5)/4;
  tunda=256-tunda;
  myservo.write(pos);                 
